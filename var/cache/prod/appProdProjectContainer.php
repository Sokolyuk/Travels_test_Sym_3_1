...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0ZCi-goRxX', '', '7JwSuuKSHHFPf4uHaz8Evg', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vpjTD1KMdk', '', '7JwSuuKSHHFPf4uHaz8Evg', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Travels\ServiceBundle\Classes\XHRequester A Travels\ServiceBundle\Classes\XHRequester instance.
     */
    protected function getXhrequesterService()
    {
        return $this->services['xhrequester'] = new \Travels\ServiceBundle\Classes\XHRequester();
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YXoQLVqMxi', '', '7JwSuuKSHHFPf4uHaz8Evg', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57610ed08ecbc8.34167387')), true);
