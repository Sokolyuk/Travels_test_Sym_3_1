...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('OvUbVZqkdR', '', (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0ZCi-goRxX', '', 'QJ92bpEQSBJWHn7SUinsWw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vpjTD1KMdk', '', 'QJ92bpEQSBJWHn7SUinsWw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8f077520e173bebbb6d8c5f37ea991485b353c8993d0adbc4ab07a86cf3d58bc');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'AsseticBundle', 6 => 'DoctrineBundle', 7 => 'SensioFrameworkExtraBundle', 8 => 'TravelsMainBundle', 9 => 'TravelsServiceBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Travels\\MainBundle/Resources/views'), 'TravelsMain');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('5fc3651f1a1bc194711d5a97aea4022d878ca8b1');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Travels\ServiceBundle\Classes\XHRequesterImpl A Travels\ServiceBundle\Classes\XHRequesterImpl instance.
     */
    protected function getXhrequesterService()
    {
        return $this->services['xhrequester'] = new \Travels\ServiceBundle\Classes\XHRequesterImpl();
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YXoQLVqMxi', '', 'QJ92bpEQSBJWHn7SUinsWw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5764c0671adda9.96379367')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TravelsMainBundle' => 'Travels\\MainBundle\\TravelsMainBundle',
                'TravelsServiceBundle' => 'Travels\\ServiceBundle\\TravelsServiceBundle',
            ),
            ...
            'secret' => '5fc3651f1a1bc194711d5a97aea4022d878ca8b1',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '5fc3651f1a1bc194711d5a97aea4022d878ca8b1',
            ...
            'validator.mapping.cache.prefix' => 'validator_29bdcd9b49e132a9501463bfc17f2465b2b5678b662e3e98814ef0a27ca3c328',
